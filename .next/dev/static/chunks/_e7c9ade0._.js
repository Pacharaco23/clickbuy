...
"[project]/lib/store/cart-store.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function CartProvider({ children }) {
            ...
            setItems({
                "CartProvider.useCallback[addItem]": (prevItems)=>{
                    const existingItem = prevItems.find({
                        "CartProvider.useCallback[addItem].existingItem": (i)=>i.id === item.id
                    }["CartProvider.useCallback[addItem].existingItem"]);
                    if (existingItem) {
    ...
    const getTotalPrice = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "CartProvider.useCallback[getTotalPrice]": ()=>{
            return items.reduce({
                "CartProvider.useCallback[getTotalPrice]": (total, item)=>total + item.price * item.quantity
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(CartContext.Provider, {
        ...
        fileName: "[project]/lib/store/cart-store.tsx",
        lineNumber: 72,
        columnNumber: 10
    }, this);
}
_s(CartProvider, "G24bAk9VFFeet00HvDKqmDLZ28c=");
_c = CartProvider;
function useCart() {
    _s1();
...
_s2(useCartStore, "LReSeQLUmY3PAl89suvC0fP3PsA=", false, function() {
    return [
        useCart
    ];
});
...
//# sourceMappingURL=_e7c9ade0._.js.map